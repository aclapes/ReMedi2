...
//    sys.setSubtractorParameters(BS_NUM_OF_SAMPLES, BS_MODALITY, BS_MAX_FEATURES, BS_LRATE, BS_QUANTIZATION_LEVELS, BS_DECISIONVAR, BS_MORPHOLOGY);

    sys.setObjectDetectorParameters(OD_LEAF_SIZE, OD_CLUSTERS_DIST_FACTOR, OD_MINIMUM_CLUSTER_SIZE);
